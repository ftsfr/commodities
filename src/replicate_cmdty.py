"""
Replicate commodity returns using correlation matching.
"""
...
def generate_corr_matrix(df_return, hkm_df):
    """Generate correlation matrix between return series and HKM factors."""
...
def decide_optimal_pairs(corr_matrix):
    """Find optimal pairs using linear sum assignment (Hungarian algorithm)."""
